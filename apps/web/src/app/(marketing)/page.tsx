    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <p className="mt-3 text-lg text-black/55 max-w-2xl">
          ...
          product goes out. Most software watches one piece. Shotline watches the
          whole loop — so the numbers finally agree with the floor.
        </p>
        <div className="mt-10 grid md:grid-cols-4 gap-4">
          {[
            ["01", "Material arrives", "Photograph the supplier invoice. Shotline reads it and books the polypropylene into stock — at what it actually cost."],
        ...
        <RevealInView className="mx-auto max-w-6xl px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-white/60 text-lg leading-relaxed">
              Shotline was built on a working factory floor in Nairobi, not in a
