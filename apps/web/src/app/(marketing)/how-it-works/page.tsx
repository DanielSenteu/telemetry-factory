      ...
      <section className="bg-white border-y border-black/5">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-x-12 gap-y-8">
            {[
              ["Does Shotline control my machines?", "No — and it never will. We read, we never write. Your machines take instructions from their own controllers and nobody else. If Shotline vanished tomorrow, your production would not notice."],
              ...
              ["Do I have to leave my invoicing system?", "No. Shotline mirrors your sales read-only. You keep invoicing exactly as you do today; we turn that history into stock movements and a demand picture."],
