        ...
        <RevealInView className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-x-12 gap-y-8">
            {[
              ...
              ["Do I have to leave my invoicing system?", "No. Industrial-Sync connects to it both ways, as a proper MES should: your sales flow in to drive stock and demand, and production output and stock levels post back into Zoho, Odoo or your bookkeeping system. You keep invoicing exactly as you do today; the two systems simply agree with each other, automatically."],
